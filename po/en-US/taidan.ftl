...
page-codecs-desc2 = Consult the {$wiki} if you don't have an Internet connection.
...
page-inputmethod-desc1 = You may <b>optionally</b> choose to add an {$ime}. This allows you to type in other specific languages. This change will take effect after you login inot your user account.
...
page-theme-desc = Make this system your own with a splash of colour.
